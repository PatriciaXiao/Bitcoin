	...
	d3.json("data/block.json",function(originalData){
	  	...
	  	var rects = svg.selectAll(".MyRect")
	  		...
	  		var startPlay=function(){
	  			...
	  			var detailInfo
	  			detailInfo="&nbsp;&nbsp;amount: "+amount+"BTC<br>&nbsp;&nbsp;Time: "+nowTime+"<br>&nbsp;&nbsp;Relayed by: "+myip+"<br>&nbsp;&nbsp;Location: "+country;
	  			/*var eventChinese = function(){ 
	  			  detailInfo="&nbsp;&nbsp;交易额: "+amount+"BTC<br>&nbsp;&nbsp;时间: "+nowTime+"<br>&nbsp;&nbsp;传播地址: "+myip+"<br>&nbsp;&nbsp;位置: "+country;
	  			  document.getElementById("detial").innerHTML= detailInfo;
	  			} 
	  			var eventEnglish = function(){ 
	  			  detailInfo="&nbsp;&nbsp;Amount: "+amount+"BTC<br>&nbsp;&nbsp;Time: "+nowTime+"<br>&nbsp;&nbsp;Relayed by: "+myip+"<br>&nbsp;&nbsp;Location: "+country;
	  			  document.getElementById("detial").innerHTML= detailInfo;
	  			} */

	  			/*var btnCN = document.getElementById("ChineseBtn");
	  			btnCN.addEventListener("click",eventChinese); 

	  			var btnEN = document.getElementById("ChineseBtn");
	  			btnEN.addEventListener("click",eventEnglish); */
	  			//alert(detailInfo)
   				document.getElementById("detial").innerHTML= detailInfo;
	  		}
