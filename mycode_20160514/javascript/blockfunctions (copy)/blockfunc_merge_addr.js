function block_merge_color(d, color, colorB){
	var colorRGB = "#000000";
...
function update(graph) {
	...
	/*
 //resize(width, height);
  //d3.select(window).on("resize", function() {resize(width, height);});
window.addEventListener('resize', function() {resize(width, height);}); 
